...
#list of  all  TCGA cancers https://gdc.cancer.gov/resources-tcga-users/tcga-code-tables/bcr-batch-codes
...
tissues<-c("COAD") #colon adenocarcinoma
...
BigQuerySQL_start_end <- paste("#standardSQL
                     with topCNVs as",
                         ...
                         "COUNT(*) AS total",
                         "FROM",
                         "`isb-cgc.TCGA_hg38_data_v0.DNA_methylation` cn", #look for DNA Methylation data https://console.cloud.google.com/bigquery?authuser=1&cloudshell=false&project=symbolic-rope-182022&supportedpurview=project&p=isb-cgc&d=TCGA_hg19_data_v0&t=DNA_Methylation_chr1&page=table
                         "JOIN",
                         ...
                         "FROM",
                         "`isb-cgc.TCGA_hg38_data_v0.DNA_Methylation` cn", #DNA Methylation
                         "JOIN",
                         "`isb-cgc.TCGA_bioclin_v0.Biospecimen` bs",
                         "ON",
                         "cn.sample_barcode = bs.sample_barcode",
